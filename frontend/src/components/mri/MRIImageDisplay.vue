...
const hasOriginal = computed(() => !!props.originalImage && !originalLoadFailed.value);
const hasAttention = computed(() => !!props.attentionMap && !attentionLoadFailed.value);

const handleOriginalError = () => {
  originalLoadFailed.value = true;
};

const handleAttentionError = () => {
